...
public class SessionPullNResponseHandler extends PullNRequestAndResponseHandler
{
    private final BookmarksHolder bookmarksHolder;

    public SessionPullNResponseHandler( Statement statement, RunResponseHandler runResponseHandler,
